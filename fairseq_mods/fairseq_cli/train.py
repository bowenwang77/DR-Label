...
def main(cfg: FairseqConfig) -> None:
    ...
    train_meter.start()
    if cfg.dataset.valid_subset.split(",")[0].split("_")[0]=='test' and cfg.task.data.split('/')[-1]!='SAA':
...
def cli_main(
    ...
    if args.data_url is not None:
        args.tensorboard_logdir = args.train_url+"/"+args.save_dir+"/tsb_rec"
        args.data = args.data_url
        args.save_dir = args.train_url+"/"+args.save_dir
